  ...
  types: {
    AuthorModelFilter: {
      ...
      inputFields: [
        ...
        {
          name: 'id';
          type: { kind: 'INPUT_OBJECT'; name: 'ItemIdFilter'; ofType: null };
          defaultValue: null;
        },
        {
    ...
    CategoryModelFilter: {
      ...
      inputFields: [
        ...
        {
          name: 'slug';
          type: { kind: 'INPUT_OBJECT'; name: 'SlugFilter'; ofType: null };
          defaultValue: null;
        },
        {
          name: 'OR';
    ...
    PostModelContentField: {
      kind: 'OBJECT';
      name: 'PostModelContentField';
      fields: {
        blocks: {
          name: 'blocks';
          type: {
    ...
    PostModelFilter: {
      ...
      inputFields: [
        ...
        {
          name: 'author';
          type: { kind: 'INPUT_OBJECT'; name: 'LinkFilter'; ofType: null };
          defaultValue: null;
        },
        {
          name: 'category';
      ...
      fields: {
        ...
        author: {
          ...
          type: {
            kind: 'NON_NULL';
            name: never;
            ofType: { kind: 'OBJECT'; name: 'AuthorRecord'; ofType: null };
          };
        };
        category: {
          name: 'category';
          type: { kind: 'OBJECT'; name: 'CategoryRecord'; ofType: null };
        };
        content: {
          name: 'content';
          type: { kind: 'OBJECT'; name: 'PostModelContentField'; ofType: null };
        };
        coverImage: {
          name: 'coverImage';
          type: {
    ...
    Query: {
      ...
      fields: {
          ...
          type: {
            ...
            ofType: {
              ...
              ofType: {
                kind: 'NON_NULL';
                name: never;
                ofType: { kind: 'OBJECT'; name: 'PostRecord'; ofType: null };
              };
            };
          };
        };
        ...
        author: {
          name: 'author';
          type: { kind: 'OBJECT'; name: 'AuthorRecord'; ofType: null };
        };
        blog: {
          name: 'blog';
          type: { kind: 'OBJECT'; name: 'BlogRecord'; ofType: null };
        };
        category: {
          name: 'category';
          type: { kind: 'OBJECT'; name: 'CategoryRecord'; ofType: null };
        ...
        post: {
          name: 'post';
          type: { kind: 'OBJECT'; name: 'PostRecord'; ofType: null };
        };
        upload: {
          name: 'upload';
          type: { kind: 'OBJECT'; name: 'FileField'; ofType: null };
